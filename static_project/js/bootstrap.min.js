...
not([size])
:
not([multiple]), select.form - control - sm
:
not([size])
:
not([multiple])
...
not([size])
:
not([multiple]), select.form - control - lg
:
not([size])
:
not([multiple])
...
@supports((-webkit - transform - style:
preserve - 3
d
)
or(transform - style
...
focus, a.bg - primary
:
hover, button.bg - primary
:
focus, button.bg - primary
:
hover
{
    background - color
...
:
hover, button.bg - secondary
:
focus, button.bg - secondary
:
hover
{
    background - color
...
focus, a.bg - info
:
hover, button.bg - info
:
focus, button.bg - info
:
hover
{
    background - color
...
focus, a.bg - warning
:
hover, button.bg - warning
:
focus, button.bg - warning
:
hover
{
    background - color
...
focus, a.bg - danger
:
hover, button.bg - danger
:
focus, button.bg - danger
:
hover
{
    background - color
...
focus, a.bg - light
:
hover, button.bg - light
:
focus, button.bg - light
:
hover
{
    background - color
...
focus, a.bg - dark
:
hover, button.bg - dark
:
focus, button.bg - dark
:
hover
{
    background - color
